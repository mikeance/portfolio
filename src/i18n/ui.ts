...
export const ui = {
  en: {
    ...
    'seo.home.description': 'Fotógrafo analógico en Madrid: retrato, editorial y campañas en 35mm. Film photographer based in Madrid — portraits, editorial and brand campaigns shot on film.',
    ...
    'seo.faces.description': 'Retratos analógicos en 35mm de Miguel Antón, fotógrafo en Madrid. Film portraits shot in Madrid and on the road.',
    'seo.editorial.title': 'Editorial · Moda y lookbooks en 35mm',
    ...
    'seo.work.description': '{name}: fotografía analógica en 35mm por Miguel Antón, fotógrafo en Madrid. Film photography for {name}.',
